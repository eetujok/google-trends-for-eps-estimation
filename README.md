...
# Branded Keyword Spikes Impact on Earning Surprises

0. Introduction

This project explores whether search interest in a company’s brands can impact the companys financial performance. Using Google Trends data, the analysis measures "relative popularity" spikes, assings them to fisical quarters and analyzes what impact the spikes have on earnings.
